...
?>
        ...
        <div class="card-body">
            <form action="?m=mapel&s=update" method="post">
                <div class="mb-3">
                    <input type="text" name="mata_pelajaran" value="<?= $r['mata_pelajaran']; ?>" class="form-control" placeholder="Nama mapel" required autofocus>
                </div>
                <div class="mb-3">
                    <input type="number" name="jam" value="<?= $r['jam']; ?>" class="form-control" placeholder="Kapasitas" required>
                </div>
